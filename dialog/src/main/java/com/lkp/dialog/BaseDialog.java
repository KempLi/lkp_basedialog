...
import com.lkp.dialog.action.ActivityAction;
import com.lkp.dialog.action.AnimAction;
import com.lkp.dialog.action.ClickAction;
import com.lkp.dialog.action.HandlerAction;
import com.lkp.dialog.action.KeyboardAction;
import com.lkp.dialog.action.ResourcesAction;
...
/**
 * @Author: KempLi
 * @Date: 2023/12/1 16:59
 * @Description: Dialog 技术基类
 */
public class BaseDialog extends AppCompatDialog implements LifecycleOwner,
        ResourcesAction, HandlerAction, ClickAction, AnimAction, KeyboardAction,
...
//        }
        public B setText(TextView textView, CharSequence text) {
         ...
         * 设置文本颜色
         */
        public B setTextColor(TextView textView, @ColorInt int color) {
...
//        }
        public B setHint(TextView textView, CharSequence text) {
         ...
         * 设置可见状态
         */
        public B setVisibility(View view, int visibility) {
         ...
         * 设置背景
         */
        public B setBackground(View view, @DrawableRes int drawableId) {
            return setBackground(view, ContextCompat.getDrawable(mContext, drawableId));
        }

        public B setBackground(View view, Drawable drawable) {
         ...
         * 设置图片
         */
        public B setImageDrawable(ImageView imageView, @DrawableRes int drawableId) {
            return setBackground(imageView, ContextCompat.getDrawable(mContext, drawableId));
        }

        public B setImageDrawable(ImageView imageView, Drawable drawable) {
